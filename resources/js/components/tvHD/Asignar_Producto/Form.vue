    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="card shadow">
          <div class="card-header bg-primary text-white">Asignar Producto as</div>
...
export default {
  ...
  methods: {
    ...
    buscarProducto() {
      axios.get(`/productos/buscar/${this.producto.cod_producto}`)
        .then(response => {
    ...
    axios.post('/asignar-producto', asignaciones)
        .then(() => {
