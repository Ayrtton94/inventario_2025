    ...
    export default {
        ...
        methods: {
            ...
            async loadDetailProduct(page = 1) {
                try {
                    const response = await axios.get(`/listar/detailproductodth?page=${page}`);
            ...
            irCrear() {
                window.location.href = '/detalles_productodth/create';
            },

            irEditar(id) {
                window.location.href = `/detalles_productodth/${id}/edit`;
            },
            ...
            eliminar(id) {
                Swal.fire({
                    ...
                    try {
                        await axios.delete(`/detalles_productodth/${id}`);
