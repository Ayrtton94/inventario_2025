            ...
            <div>
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <button @click="irCrear" class="btn btn-success shadow-sm" v-if="can('tecnico.create')" hidden>
                            Crear Nuevo
                        </button>
                        ...
                        <tbody>
                            <tr v-for="form_teco in form_tecos" :key="form_teco.id">
                                <td width="10px">
                                    <button @click="irEditar(form_teco.id)" class="btn btn-warning btn-sm" v-if="can('tecnico.edit')">
                                        <i class="fas fa-edit"></i> 
                                    </button>                                    
                                </td>
                                <td width="10px">
                                    <button @click="eliminar(form_teco.id)" class="btn btn-danger btn-sm" v-if="can('tecnico.destroy')">
                                        <i class="fas fa-trash-alt"></i>
                                    </button>
                                </td>
                                <td>{{ form_teco.id }}</td>
                                <td>{{ form_teco.abonado }}</td>
                                <td>{{ form_teco.fecha_ingreso }}</td>
                                <td>{{ form_teco.nombre }}</td>
                            </tr>
                        </tbody>
                    </table>
